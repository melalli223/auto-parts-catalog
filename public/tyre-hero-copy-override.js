...
/* Finder box moved further upward so the hero visibly covers more than half of it. */
.tyreByCarExactPanel{width:min(760px,calc(100% - 20px))!important;margin:-205px auto 0!important;position:relative!important;z-index:5!important;padding:30px 38px 32px!important;box-sizing:border-box!important;background:#061e4e!important;color:#fff!important;border:0!important;border-radius:18px!important;box-shadow:0 16px 35px rgba(3,25,65,.20)!important;transform:none!important}
...
.tyreByCarBackHome{display:flex!important;align-items:center!important;justify-content:center!important;width:max-content!important;margin:34px auto 0!important;padding:0 22px!important;height:46px!important;border:2px solid #e21b23!important;border-radius:8px!important;background:#fff!important;color:#e21b23!important;font:800 14px/46px Inter,Arial,sans-serif!important;cursor:pointer!important}
.tyreByCarBackHome:hover{background:#e21b23!important;color:#fff!important}
...
@media(max-width:800px){
 ...
 .tyreByCarExactPanel{width:100%!important;margin:-145px auto 0!important;padding:24px 20px 25px!important;border-radius:15px!important}
