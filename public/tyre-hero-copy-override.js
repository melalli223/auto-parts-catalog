...
.tyreByCarExactPanel{width:min(760px,calc(100% - 20px))!important;margin:-78px auto 0!important;position:relative!important;z-index:5!important;padding:30px 38px 32px!important;box-sizing:border-box!important;background:#061e4e!important;color:#fff!important;border:0!important;border-radius:18px!important;box-shadow:0 16px 35px rgba(3,25,65,.20)!important;transform:none!important}
...
@media(max-width:800px){
 ...
 .tyreByCarExactPanel{width:100%!important;margin:-58px auto 0!important;padding:24px 20px 25px!important;border-radius:15px!important}
