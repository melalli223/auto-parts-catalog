...
const promoSection=`<section class="tyreAdminCard"><div class="tyreCardHead"><div><span class="eyebrow">02 · PROMOTIONAL PANELS</span><h3>Winter, Summer & Custom Wheels</h3><p>Each panel has its own text, image and enquiry message.</p></div></div>
 ...
 const finderCarSection=`<section class="tyreAdminCard"><div class="tyreCardHead"><div><span class="eyebrow">FIND TYRE BY CAR</span><h3>Find Tyre By Car</h3><p>Manage the image displayed at the bottom of the Find Tyre By Car page.</p></div></div><div class="tyreAdminHeroLayout"><div class="formGroup"><label>Bottom image</label><input id="tbCarImg" type="file" accept="image/*" class="input" onchange="prepareImageSelection(event,'tbCarImg')"><small class="helpText">Upload the image you want shown at the bottom of this finder page.</small></div><div>${preview(findByCar.bottomImage,'Find Tyre By Car bottom image')}</div></div></section>`;
 const finderNumberSection=`<section class="tyreAdminCard"><div class="tyreCardHead"><div><span class="eyebrow">FIND TYRE BY NUMBER</span><h3>Find Tyre By Number</h3><p>Manage the image displayed at the bottom of the Find Tyre By Number page.</p></div></div><div class="tyreAdminHeroLayout"><div class="formGroup"><label>Bottom image</label><input id="tbNumberImg" type="file" accept="image/*" class="input" onchange="prepareImageSelection(event,'tbNumberImg')"><small class="helpText">Upload the image you want shown at the bottom of this finder page.</small></div><div>${preview(findByNumber.bottomImage,'Find Tyre By Number bottom image')}</div></div></section>`;
