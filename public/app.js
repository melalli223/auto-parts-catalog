...
const promoSection=`<section class="tyreAdminCard"><div class="tyreCardHead"><div><span class="eyebrow">02 · PROMOTIONAL PANELS</span><h3>Winter, Summer & Custom Wheels</h3><p>Each panel has its own text, image and enquiry message.</p></div></div>
 ...
 const bottomSection=`<section class="tyreAdminCard" id="tyreBottomSection"><div class="tyreCardHead"><div><span class="eyebrow">03 · BOTTOM IMAGE</span><h3>Bottom banner image</h3><p>Controls the decorative image at the very bottom of the public tyre page.</p></div></div><div class="tyreAdminHeroLayout"><div><div class="formGroup"><label>Find Tyre By Car — bottom image</label><input id="tbCarImg" type="file" accept="image/*" class="input" onchange="prepareImageSelection(event,'tbCarImg')"><small class="helpText">This image appears at the bottom of the Find Tyre By Car page.</small></div><div class="formGroup"><label>Find Tyre By Number — bottom image</label><input id="tbNumberImg" type="file" accept="image/*" class="input" onchange="prepareImageSelection(event,'tbNumberImg')"><small class="helpText">This image appears at the bottom of the Find Tyre By Number page.</small></div></div><div><div class="tyreAdminPreviewGrid"><div><small class="helpText">By Car</small>${preview(t.findByCar?.bottomImage||t.bottomImage||defaultTyres.bottomImage,'Find Tyre By Car bottom image')}</div><div><small class="helpText">By Number</small>${preview(t.findByNumber?.bottomImage||t.bottomImage||defaultTyres.bottomImage,'Find Tyre By Number bottom image')}</div></div></div></div></section>`;
