...
`+`\n.tyreByCarImageCopy{position:absolute;z-index:3;top:82px;left:50%;transform:translateX(-50%);width:min(850px,92%);text-align:center}.tyreByCarImageCopy .tyreByCarEyebrow{margin:0 0 12px;color:#ff2b2f;font-size:18px;font-weight:800;letter-spacing:.8px;text-transform:uppercase;text-shadow:0 2px 8px rgba(0,0,0,.35)}.tyreByCarImageCopy h1{margin:0;color:#fff;font-size:52px;font-weight:800;line-height:1.08;letter-spacing:-1.8px;text-shadow:0 2px 8px rgba(0,0,0,.35)}.tyreByCarBackHome{display:flex;align-items:center;justify-content:center;width:max-content;margin:34px auto 0 30px;padding:0 22px;height:46px;border:2px solid #e21b23;border-radius:8px;background:#fff;color:#e21b23;font:800 14px/42px Inter,Arial,sans-serif;cursor:pointer}.tyreByCarBackHome span{margin-right:7px}@media(max-width:800px){.tyreByCarImageCopy{top:58px;width:94%}.tyreByCarImageCopy h1{font-size:38px;letter-spacing:-1px}.tyreByCarBackHome{margin:45px auto 0 16px}}\n.tyreCustomSelectList,.tyreCustomSelectList *{box-sizing:border-box!important}.tyreByCarExactField .tyreCustomSelectList{background-color:#173765!important;background-image:none!important;color:#fff!important}.tyreByCarExactField .tyreCustomSelectOption{background-color:#173765!important;background-image:none!important;color:#fff!important}.tyreByCarExactField .tyreCustomSelectOption:hover,.tyreByCarExactField .tyreCustomSelectOption.selected{background-color:#214776!important;color:#fff!important}`;document.head.appendChild(s)}
...
window.tyresByCar=function(){
  ...
  render(`<section class="tyreExactPage"><section class="tyreByCarHero" style="background-image:url('${esc(heroImage)}')"><div class="tyreByCarHeroInner"><div class="tyreByCarImageCopy"><p class="tyreByCarEyebrow">The right tyre. Every journey.</p><h1>Find the perfect tyres<br>for your vehicle</h1></div></div></section><div class="tyreByCarFinderWrap"><section class="tyreByCarExactPanel"><div class="tyreByCarPanelHeader"><h2>Find tyre by car</h2><p class="required">Select your vehicle details to see the right tyres for your car.</p></div><div class="tyreByCarExactFields"><div class="tyreByCarExactField"><label>Brand</label><div id="brandDropdown"></div></div><div class="tyreByCarExactField" id="modelField" style="display:none"><label>Model</label><div id="modelDropdown"></div></div></div><div class="tyreByCarExactActions"><button id="exactContinue" type="button" disabled>Find Tyres</button></div></section></div><div class="tyreByCarHeroCopy"><p class="tyreByCarEyebrow">The right tyre. Every journey.</p><h1>Find the perfect tyres<br>for your vehicle</h1><p class="tyreByCarHeroSub">Choose your car brand and model to find the right tyres that match your vehicle and driving needs.</p></div><div class="tyreByCarBottomSpace" aria-hidden="true"></div><button type="button" class="tyreByCarBackHome"><span>←</span> Back to home</button><div class="tyreFinderBottomImage">${(tyres.findByCar&&tyres.findByCar.bottomImage)?`<img src="${esc(tyres.findByCar.bottomImage)}" alt="Car brands" loading="lazy">`:''}</div></section>`);
