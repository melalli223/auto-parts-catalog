...
function addStyle(){if(document.getElementById(styleId))return;const s=document.createElement('style');s.id=styleId;s.textContent='.tyreExactPage{min-height:100vh!important;margin:0!important;padding:0!important;background:#fff!important}.tyreByCarHero{width:100%;height:360px;position:relative;overflow:hidden;background:#14283f url("/assets/tyre-ref/hero.png") center/cover no-repeat}';document.head.appendChild(s)}
