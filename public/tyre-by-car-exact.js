...
window.tyresByCar=function(){
  ...
  render(`<section class="tyreExactPage"><section class="tyreByCarHero" style="background-image:url('${esc(heroImage)}?v=${Date.now()}')"><div class="tyreByCarHeroInner"></div></section><div class="tyreByCarFinderWrap"><section class="tyreByCarExactPanel"><div class="tyreByCarPanelHeader"><h2>Find tyre by car</h2><p class="required">Select your vehicle details to see the right tyres for your car.</p></div><div class="tyreByCarExactFields"><div class="tyreByCarExactField"><label>Brand</label><div id="brandDropdown"></div></div><div class="tyreByCarExactField" id="modelField" style="display:none"><label>Model</label><div id="modelDropdown"></div></div></div><div class="tyreByCarExactActions"><button id="exactContinue" type="button" disabled>Find Tyres</button></div></section></div><div class="tyreByCarHeroCopy"><p class="tyreByCarEyebrow">The right tyre. Every journey.</p><h1>Find the perfect tyres<br>for your vehicle</h1><p class="tyreByCarHeroSub">Choose your car brand and model to find the right tyres that match your vehicle and driving needs.</p></div><div class="tyreByCarBottomSpace" aria-hidden="true"></div><div class="tyreFinderBottomImage">${(tyres.findByCar&&tyres.findByCar.bottomImage)?`<img src="${esc(tyres.findByCar.bottomImage)}?v=${Date.now()}" alt="Car brands" loading="lazy">`:''}</div></section>`);
...
(function(){function route(){const p=location.hash.replace(/^#/,'').split('/');if(p[0]==='tyres'&&p[1]==='by-car'&&typeof window.tyresByCar==='function')window.tyresByCar()}window.addEventListener('hashchange',route);window.addEventListener('load',()=>setTimeout(route,150));})();

.tyreByCarExactField>.tyreCustomSelect{display:block}.tyreByCarExactField .tyreCustomSelectDisplay{display:block;width:100%;height:56px;box-sizing:border-box;border:1px solid rgba(255,255,255,.2);border-radius:12px;background:#173765;color:#fff;padding:0 48px 0 18px;font:600 16px/56px Inter,Arial,sans-serif;text-align:left;position:relative;cursor:pointer}.tyreByCarExactField .tyreCustomSelectDisplay:after{content:'';position:absolute;right:18px;top:20px;width:9px;height:9px;border-right:2px solid #fff;border-bottom:2px solid #fff;transform:rotate(45deg)}.tyreByCarExactField .tyreCustomSelect.open .tyreCustomSelectDisplay{border-color:#fff;box-shadow:0 0 0 2px rgba(255,255,255,.08)}.tyreByCarExactField .tyreCustomSelectDisplay:disabled{opacity:.5;cursor:not-allowed}.tyreByCarExactField .tyreCustomSelectList{display:none;position:absolute;left:0;right:0;top:calc(100% + 6px);z-index:9999;max-height:280px;overflow-y:auto;padding:6px;background:#173765!important;border:1px solid rgba(255,255,255,.2)!important;border-radius:12px;box-shadow:0 12px 30px rgba(0,0,0,.25)}.tyreByCarExactField .tyreCustomSelectList.show{display:block!important}.tyreByCarExactField .tyreCustomSelectOption{display:block;width:100%;min-height:44px;margin:0;padding:10px 14px;background:#173765!important;color:#fff!important;border:0;border-radius:8px;font:600 15px/24px Inter,Arial,sans-serif;text-align:left;cursor:pointer}.tyreByCarExactField .tyreCustomSelectOption:hover,.tyreByCarExactField .tyreCustomSelectOption.selected{background:#214776!important;color:#fff!important}.tyreByCarExactField .tyreCustomSelect{position:relative;width:100%}
