...
window.tyresByCar=function(){
  ...
  render(`<section class="tyreExactPage"><section class="tyreByCarHero" style="background-image:url('${esc(heroImage)}')"><div class="tyreByCarHeroInner"></div></section><div class="tyreByCarFinderWrap"><section class="tyreByCarExactPanel"><div class="tyreByCarPanelHeader"><h2>Find tyre by car</h2><p class="required">Select your vehicle details to see the right tyres for your car.</p></div><div class="tyreByCarExactFields"><div class="tyreByCarExactField"><label>Brand</label><div id="brandDropdown"></div></div><div class="tyreByCarExactField" id="modelField" style="display:none"><label>Model</label><div id="modelDropdown"></div></div></div><div class="tyreByCarExactActions"><button id="exactContinue" type="button" disabled>Find Tyres</button></div></section></div><div class="tyreByCarHeroCopy"><p class="tyreByCarEyebrow">The right tyre. Every journey.</p><h1>Find the perfect tyres<br>for your vehicle</h1><p class="tyreByCarHeroSub">Choose your car brand and model to find the right tyres that match your vehicle and driving needs.</p></div><div class="tyreByCarBottomSpace" aria-hidden="true"></div><div class="tyreFinderBottomImage">${(tyres.findByCar&&tyres.findByCar.bottomImage)?`<img src="${esc(tyres.findByCar.bottomImage)}" alt="Car brands" loading="lazy">`:''}</div></section>`);
